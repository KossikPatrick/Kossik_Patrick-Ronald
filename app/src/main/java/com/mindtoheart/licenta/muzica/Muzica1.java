...
public class Muzica1 extends AppCompatActivity {
    Button play_btn, back_btn, forward_btn, stop_btn;
    TextView time_txt, yttext;
    SeekBar seekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica1);
        getSupportActionBar().setTitle("Sunete liniștite ale pădurii");
        ...
        yttext=findViewById(R.id.textYoutube);
        String youtubeLink = "https://youtu.be/4S3yJkGWM4E";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.padure );
