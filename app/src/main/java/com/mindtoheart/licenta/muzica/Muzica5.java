...
public class Muzica5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica5);
        getSupportActionBar().setTitle("Muzică de meditație");
        ...
        String youtubeLink = "https://youtu.be/ru4hdcMmlwQ";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.medmus);
