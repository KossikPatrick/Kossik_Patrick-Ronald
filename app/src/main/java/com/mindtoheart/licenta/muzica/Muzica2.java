...
public class Muzica2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica2);
        getSupportActionBar().setTitle("Pârâu de munte");
        ...
        String youtubeLink = "https://youtu.be/4hXYRXaJdtk";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.parau );
