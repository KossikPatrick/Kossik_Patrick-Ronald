...
public class Muzica10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica10);
        getSupportActionBar().setTitle("Sunete binaurale");
        ...
        String youtubeLink = "https://youtu.be/dxGU80Ny0JQ";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.binaural );
