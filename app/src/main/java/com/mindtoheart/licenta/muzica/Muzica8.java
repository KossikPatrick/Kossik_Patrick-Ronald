...
public class Muzica8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica8);
        getSupportActionBar().setTitle("Sunete Lofi");
        ...
        String youtubeLink = "https://youtu.be/AzV77KFsLn4";
