...
public class Muzica9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica9);
        getSupportActionBar().setTitle("Muzică ambientală");
        ...
        String youtubeLink = "https://youtu.be/PIhIc_ehSdU";
