...
public class Muzica7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica7);
        getSupportActionBar().setTitle("Muzică relaxantă vioară");
        ...
        String youtubeLink = "https://youtu.be/V_w4lfNJ9lA";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.vioara );
