...
public class Muzica3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica3);
        getSupportActionBar().setTitle("Sunet flaut himalayan");
        ...
        String youtubeLink = "https://youtu.be/tF4z5kntXAA";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.flaut );
