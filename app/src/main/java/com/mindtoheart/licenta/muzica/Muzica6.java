...
public class Muzica6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica6);
        getSupportActionBar().setTitle("Muzică relaxantă pian");
        ...
        String youtubeLink = "https://youtu.be/rkAWbFwa0eI";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.pian );
