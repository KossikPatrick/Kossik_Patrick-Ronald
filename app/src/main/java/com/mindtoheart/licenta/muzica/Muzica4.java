...
public class Muzica4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzica4);
        getSupportActionBar().setTitle("Vas cântător tibetan");
        ...
        String youtubeLink = "https://youtu.be/fGuiJHHSFTs";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.tibetan );
