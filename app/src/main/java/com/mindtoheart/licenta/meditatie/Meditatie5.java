...
public class Meditatie5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditatie5);
        getSupportActionBar().setTitle("Încrederea în sine");
        ...
        String youtubeLink = "https://youtu.be/vuq3CmuGoXI";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.incredere );
