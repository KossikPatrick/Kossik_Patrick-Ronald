...
public class Meditatie7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditatie7);
        getSupportActionBar().setTitle("Vindecarea fricii de boală");
        ...
        String youtubeLink = "https://youtu.be/eosm_fD_BiA";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.sanatate );
