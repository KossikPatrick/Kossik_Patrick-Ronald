...
public class Meditatie4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditatie4);
        getSupportActionBar().setTitle("Inspirație pentru dimineață");
        ...
        String youtubeLink = "https://youtu.be/lUQkFS3oh0E";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.motivatia_de_dimineata );
