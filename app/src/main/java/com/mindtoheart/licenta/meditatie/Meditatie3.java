...
public class Meditatie3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditatie3);
        getSupportActionBar().setTitle("Schimbarea Credințelor Negative");
        ...
        String youtubeLink = "https://youtu.be/ZSOg3MJrq0s";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.schimbarea_credintelor_negative );
