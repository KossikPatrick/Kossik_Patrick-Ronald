...
public class Meditatie2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditatie2);
        getSupportActionBar().setTitle("Iertarea și vindecarea trecutului");
        ...
        String youtubeLink = "https://youtu.be/T3iq1r-EmZc";
        ...
        mediaPlayer= MediaPlayer.create(this, R.raw.iertarea_vindecarea_trecutului );
